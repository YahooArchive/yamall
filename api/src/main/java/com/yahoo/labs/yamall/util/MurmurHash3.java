 ...
 * <p>
 * The MurmurHash3 algorithm was created by Austin Appleby and placed in the public domain. This java port was authored by Yonik Seeley and also placed into the
 ...
 * <p>
 * The 32 bit x86 version of this hash should be the fastest variant for relatively short keys like ids. murmurhash3_x64_128 is a good choice for longer strings
 * or if you need more than 32 bits of hash.
 * <p>
 ...
 * 
 * @author Yonik Seeley, Francesco Orabona
 * @version 1.0
 */
public final class MurmurHash3 {
    ...
    /**
     * Hash the string and does a bitwise and operation with the mask.
     * <p>
     * If mask_hash is a mask of all 1s (in binary), up to 31 bits, the result is always positive.
     * 
     * @param name
     *            string to be hashed.
     * @param mask_hash
     *            mask to be used in the bitwise and.
     * @return the hashed and masked index.
     */
    public static int maskedHash(String name, int mask_hash) {
        final int hashed = MurmurHash3.murmurhash3_x86_32(name, 0, name.length(), 0) & mask_hash;
        return hashed;
    }
